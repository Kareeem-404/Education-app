...
import { defaultNodes } from "../FullStackPage/Nodes";
import { defaultEdges } from "../FullStackPage/edge";
    ...
    <>
      ...
      >
        ...
        <div style={{ width: "1200px", height: "800px" }}>
          ...
          <h1 className="mt-9 mb-2 text-center text-4xl">FULL STACK Road Map</h1>
